...
import { CaseSensitive, Info, X } from "@/icons";
import { useOperators, useUniqueExternalAgentIds } from "@/tools/policy.query";
import type { PolicyCondition } from "@/tools/policy.utils";
