...
import { useDeleteMcp, useMcpServers } from "@/mcp-registry/mcp-registry.query";
import { useDeleteMcpServer, useInstallMcpServer } from "@/mcp-registry/mcp-server.query";
